...
import br.com.senacead.pousadaappjpa.persistencia.CaixaDAO;
import br.com.senacead.pousadaappjpa.persistencia.Gastos;
import br.com.senacead.pousadaappjpa.persistencia.GastosDAO;
import br.com.senacead.pousadaappjpa.persistencia.Hospede;
import br.com.senacead.pousadaappjpa.persistencia.HospedeDAO;
import br.com.senacead.pousadaappjpa.persistencia.Relatorio;
...
//Método para atualizar o PainelCaixa
    ...
    private void initComponents() {
        ...
        btnRelatorio.setForeground(new java.awt.Color(0, 102, 153));
        btnRelatorio.setText("Relatório Completo");
        btnRelatorio.setBorder(javax.swing.BorderFactory.createMatteBorder(1, 1, 1, 1, new java.awt.Color(0, 102, 153)));
        ...
        jButton1.setText("Relstório Resumido");
        ...
        PainelCaixaLayout.setVerticalGroup(
            ...
            .addGroup(PainelCaixaLayout.createSequentialGroup()
                ...
                .addGroup(PainelCaixaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(PainelCaixaLayout.createSequentialGroup()
                        .addGap(10, 10, 10)
                        .addComponent(btnRelatorio, javax.swing.GroupLayout.PREFERRED_SIZE, 27, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addGap(3, 3, 3)
                .addGroup(PainelCaixaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
    ...
    private void btnSalvaGastoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvaGastoActionPerformed
        ...
        try {
            ...
            boolean gastocadastrado = gastodao.cadastrarGasto(gasto);
...
// Quarto e valor da diária
        ...
        try {
            ...
            boolean cadastro = hospededao.cadastrarHospede(hospede);
    ...
    private void btnOkExcluiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnOkExcluiActionPerformed
        ...
        try {
            ...
            if (!txtEntraExclusao.getText().isEmpty()) {
                ...
                gastodao.excluirPorIDDigitado(id);
            }
